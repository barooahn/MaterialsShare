describe("Public Method Tests", function () {
    ...
    describe("'setValue()' tests", function () {
        var formatInvalidInputMsg = function (invalidValue) {
            return "Invalid input value '" + invalidValue + "' passed in";
        };
    ...
    afterEach(function () {
        if (testSlider) {
            if (testSlider instanceof jQuery) {
                testSlider.slider('destroy');
            }
            if (testSlider instanceof Slider) {
                testSlider.destroy();
            }
            testSlider = null;
        }
